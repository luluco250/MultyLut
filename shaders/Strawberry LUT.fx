...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "Strawberry LUT.png"
#endif
...
#include "ReShade.fxh"
texture texStrawMultiLUT < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY*fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
sampler	SamplerMultiLUT { Texture = texStrawMultiLUT; };
