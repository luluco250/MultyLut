...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "Film Presets LUT.png"
#endif
...
#include "ReShade.fxh"
texture texFilmPreMultiLUT < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY*fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
sampler	SamplerMultiLUT { Texture = texFilmPreMultiLUT; };
