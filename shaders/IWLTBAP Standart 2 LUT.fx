...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "IWLTBAP Standart 2.png"
#endif
...
#include "ReShade.fxh"
texture texST2MultiLUT < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY*fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
sampler	SamplerMultiLUT { Texture = texST2MultiLUT; };
...
technique  IWLTBAP_Stanadart_2_LUT
{
	pass MultiLUT_Apply
	{
