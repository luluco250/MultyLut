...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "Black and White LUT.png"
#endif
...
#include "ReShade.fxh"
texture texBnWMultiLUT < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY*fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
sampler	SamplerMultiLUT { Texture = texBnWMultiLUT; };
