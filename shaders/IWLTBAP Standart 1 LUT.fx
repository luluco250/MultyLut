...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	#define fLUT_TextureName "IWLTBAP Standart 1.png"
#endif
...
#include "ReShade.fxh"
texture texSTMultiLUT < source = fLUT_TextureName; > { Width = fLUT_TileSizeXY*fLUT_TileAmount; Height = fLUT_TileSizeXY * fLUT_LutAmount; Format = RGBA8; };
sampler	SamplerMultiLUT { Texture = texSTMultiLUT; };
...
technique  IWLTBAP_Stanadart_1_LUT
{
	pass MultiLUT_Apply
	{
